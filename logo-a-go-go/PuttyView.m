...
//    [[NSNotificationCenter defaultCenter] postNotificationName:@"ActiveStampTouched" object:contentView.image];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ActiveStampTouched" object:self];
